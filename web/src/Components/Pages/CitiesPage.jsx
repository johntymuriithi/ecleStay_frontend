...
const CitiesPage = () => {
  ...
  useEffect(() => {
    console.log('CitiesPage mounted');
  ...
  return (
    <div className="w-full h-full flex flex-col bg-white">
      <h1 className="text-3xl font-bold ml-10 mt-11 mb-4">Explore amazing places</h1>
      <div className="flex flex-wrap md:ml-10 ml-0">
        {/* Room Details */}
        <div className="w-full md:w-1/2 mb-4 md:mb-0">
          <img className="mx-auto lg:ml-20 w-[70%] h-auto rounded" src={citiesData.imageUrl} alt={citiesData.name} />
        ...
        <div className="w-full md:w-1/2 md:pl-3 grid grid-cols-2 gap-4">
          <div className="flex flex-col justify-between">
            <img className="w-full h-auto rounded mb-4" src={City1} alt="City 1" />
            <img className="w-full h-auto rounded" src={city2} alt="city 2" />
          </div>
          <div className="flex flex-col justify-between">
            <img className="w-full h-auto rounded mb-4" src={city3} alt="city 3" />
            <img className="w-full h-auto rounded" src={city4} alt="city 4" />
          </div>
        </div>
      </div>
