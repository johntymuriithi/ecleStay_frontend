...
const BeachPage = () => {
  ...
  const beachData = location.state?.beachData;
    ...
    <div className="w-full h-full flex flex-col bg-white">
      ...
      <div className="flex flex-wrap md:ml-10 ml-0">
        ...
        <div className="w-full md:w-1/2 mb-4 md:mb-0">
          <img className="mx-auto lg:ml-20 w-[70%] h-auto rounded" src={beachData.imageUrl} alt={beachData.name} />
        ...
        <div className="w-full md:w-1/2 md:pl-3 grid grid-cols-2 gap-4">
          <div className="flex flex-col justify-between">
            ...
            <img className="w-full h-auto rounded" src={beach2} alt="beach2" />
          </div>
          <div className="flex flex-col justify-between">
            <img className="w-full h-auto rounded mb-4" src={beach3} alt="beach3" />
            <img className="w-full h-auto rounded" src={beach4} alt="beach4" />
          </div>
        </div>
      </div>
